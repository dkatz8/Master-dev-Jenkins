...
Reporter.ReportEvent micPass, "AOB login", " AOB login successes !"
	...
	Reporter.ReportEvent micFail, "AOB Login ", " UI element 'Login Button' is present but not clickable" 
	ExitTest("UI element 'Login Button' is present but not clickable")
End If
